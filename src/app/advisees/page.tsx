...
const ADVISEES: Advisee[] = [
  ...
  },
  {
    ...
    achievements: [
      ...
      "Admitted to Yale School of Public Health (M.S.)",
    ],
  ...
  },
  {
    ...
    achievements: [
      ...
      "Admitted to Carnegie Mellon University School of Computer Science (M.S.)",
    ],
  ...
  },
  {
    ...
    achievements: [
      "Selected as Clinton Global Initiative University (CGI U) Fellow",
    ],
  },
  {
    ...
    achievements: [
      "Selected as Millennium Fellow (United Nations Academic Impact)",
